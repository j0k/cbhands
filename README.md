...
- **🔌 Декларативная система плагинов** - Определение плагинов через метаданные
- **📋 Группы команд** - Организация команд в логические группы (`cbhands service start`, `cbhands dev-showroom create-tables`)
- **🔄 Система middleware** - Хуки для выполнения команд
- **📡 Event Bus** - Коммуникация плагинов через события
- **⚙️ Управление конфигурацией** - Конфигурация для каждого плагина
- **🔗 Управление зависимостями** - Разрешение зависимостей плагинов
- **🔍 Автообнаружение** - Автоматическая загрузка плагинов
- **⚡ Поддержка async** - Асинхронные команды
- **🎨 Rich вывод** - Красивый консольный вывод
- **🔄 Hot-reload** - Перезагрузка плагинов в режиме разработки

### Использование v3.0.0:

```bash
# Управление сервисами
python -m cbhands.v3.main service status
python -m cbhands.v3.main service start-all
python -m cbhands.v3.main service stop-all

# Dev Showroom
python -m cbhands.v3.main dev-showroom create-tables --count 10
python -m cbhands.v3.main dev-showroom simulate-a1
